defmodule ElixirBrod.Avro.Validation.Simple do
  ...
  def validate({results, data}, name, %Field{type: type} = definition)
      when type in @simple_types do
    %_{^name => value} = data
  ...
  def is_avro_double(value),
    do:
      is_float(value) and value >= -1.7_976_931_348_623_157e308 and
        value <= 1.7_976_931_348_623_157e308
